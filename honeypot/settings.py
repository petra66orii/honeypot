...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'localhost',
    'honeypot-6aa199604c8f.herokuapp.com'
]
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'honeypot-media'
    AWS_S3_REGION_NAME = 'auto'
    AWS_ACCESS_KEY_ID = os.environ.get('AWS_ACCESS_KEY_ID')
    AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_SECRET_ACCESS_KEY')
    AWS_S3_CUSTOM_DOMAIN = f'https://736a1747e88c971bcaec3d96db03243a.r2.cloudflarestorage.com/{AWS_STORAGE_BUCKET_NAME}'
...
# JWT Configuration
REST_USE_JWT = True
JWT_AUTH_SECURE = False if 'DEVELOPMENT' in os.environ else True
